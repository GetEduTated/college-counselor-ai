...
export const BotIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    ...
    fill="currentColor"
  >
    <path d="M19 2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h4l3 3 3-3h4c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-5 9h-2V9h2v2zm-4 0H8V9h2v2zm8-4H8V5h8v2z" />
  </svg>
);
...
export const TimelineIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
        <path d="M6 2v6h.01L6.01 22H8V8h1V2H6zM10 2v10h1V2h-1zM14 2v14h1V2h-1zM18 2v18h1V2h-1z"/>
    </svg>
);
...
export const SubtaskIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
...
export const PencilRulerIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
        <path d="M22 7v2H9V7h13M2 17h13v-2H2v2M2 5v2h5V5H2m18.05 9.24l-2.83-2.83-1.06 1.06 2.83 2.83 1.06-1.06M20.94 11l-8.07 8.07c-.27.27-.64.42-1.03.42H9.5c-.97 0-1.75-.78-1.75-1.75v-2.34c0-.39.16-.76.42-1.03L18.88 6.25c.39-.39 1.02-.39 1.41 0l.65.65c.39.39.39 1.02 0 1.41l-.94.94.94.94c.39.39.39 1.02 0 1.41l-.65.65c-.38.39-1.02.39-1.41 0l-.25-.25z"/>
    </svg>
);
